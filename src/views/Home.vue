<template>
  <div class="w-screen h-screen bg-gray-50 flex flex-col justify-center items-center overflow-hidden">
    <h2 class="text-6xl mb-8">Player: {{ activePlayer }}</h2>

    <!-- Total board -->
    <div class="grid grid-cols-3 grid-rows-3">
      <div class="w-64 h-64 flex justify-center items-center border-r-4 border-b-4">
      ...
      <div class="w-64 h-64 flex justify-center items-center border-b-4">
      ...
      <div class="w-64 h-64 flex justify-center items-center border-r-4">
